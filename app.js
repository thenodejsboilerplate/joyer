...
const redis_config = config.db[env].redis;
...
app.use(session({
  ...
  store: new redisStore({port:redis_config.port, host:redis_config.host,pass:redis_config.pw, ttl:  redis_config.ttl}),//Redis session TTL (expiration) in seconds
